...
class OrderResourceIT {
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getSymptom()).isEqualTo(DEFAULT_SYMPTOM);
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.address(UPDATED_ADDRESS).symptom(UPDATED_SYMPTOM).date(UPDATED_DATE).status(UPDATED_STATUS).price(UPDATED_PRICE);
        ...
        assertThat(testOrder.getSymptom()).isEqualTo(UPDATED_SYMPTOM);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.address(UPDATED_ADDRESS).date(UPDATED_DATE).status(UPDATED_STATUS).price(UPDATED_PRICE);
