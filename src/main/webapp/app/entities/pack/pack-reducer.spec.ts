...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pack.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PACK_LIST actions', async () => {
    ...
    it('dispatches FETCH_PACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PACK actions', async () => {
      const expectedActions = [
        {
