...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './hospital.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOSPITAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOSPITAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOSPITAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOSPITAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOSPITAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOSPITAL actions', async () => {
      const expectedActions = [
        {
