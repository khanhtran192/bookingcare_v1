    ...
    <div>
      ...
      <div className="table-responsive">
        {hospitalList && hospitalList.length > 0 ? (
          ...
          !loading && <div className="alert alert-warning">No Hospitals found</div>
        )}
      </div>
      {totalItems ? (
