            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('symptom')}>
                  Symptom <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {orderList.map((order, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{order.status}</td>
                  <td>{order.price}</td>
                  <td>{order.timeslot ? <Link to={`/time-slot/${order.timeslot.id}`}>{order.timeslot.id}</Link> : ''}</td>
                  <td>{order.customer ? <Link to={`/customer/${order.customer.id}`}>{order.customer.id}</Link> : ''}</td>
                  <td>{order.doctor ? <Link to={`/doctor/${order.doctor.id}`}>{order.doctor.id}</Link> : ''}</td>
                  <td>{order.pack ? <Link to={`/pack/${order.pack.id}`}>{order.pack.id}</Link> : ''}</td>
