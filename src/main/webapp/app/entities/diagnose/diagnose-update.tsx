  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="bookingcareV1App.diagnose.home.createOrEditLabel" data-cy="DiagnoseCreateUpdateHeading">
            Create or edit a Diagnose
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? <ValidatedField name="id" required readOnly id="diagnose-id" label="ID" validate={{ required: true }} /> : null}
              <ValidatedField label="Description" id="diagnose-description" name="description" data-cy="description" type="text" />
              <ValidatedField id="diagnose-order" name="order" data-cy="order" label="Order" type="select">
                <option value="" key="0" />
                {orders
