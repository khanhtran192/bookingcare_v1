...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './diagnose.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIAGNOSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DIAGNOSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DIAGNOSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DIAGNOSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DIAGNOSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DIAGNOSE actions', async () => {
      const expectedActions = [
        {
